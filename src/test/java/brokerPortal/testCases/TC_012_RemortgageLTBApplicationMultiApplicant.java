...
public class TC_012_RemortgageLTBApplicationMultiApplicant extends BrokerPortalBaseClass{
	
	@Test
	public void RemortgageLTBApplicationMultiApplicant() throws InterruptedException	
	{
		setup("firefox");
