...
public class TC_010_PurchaseResidentialApplicationMultiApplicant extends BrokerPortalBaseClass{
	
	@Test
	public void PurchaseResidentialApplicationMultiApplicant() throws InterruptedException
	{
		setup("firefox");
